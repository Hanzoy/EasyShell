...
- `dist\runtime-required\EasyShell-v1.1.0-runtime-required.exe`：不带 .NET 运行时，文件较小，目标电脑需要安装 .NET 9 Windows Desktop Runtime
- `dist\standalone\EasyShell-v1.1.0-standalone.exe`：自包含版本，文件较大，目标电脑不需要安装 .NET
